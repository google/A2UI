...
describe('Integration: Full Protocol Scenarios', () => {
  ...
  describe('Action Dispatch', () => {
    it('dispatches action when button is clicked', async () => {
      const onAction = vi.fn<(action: A2UIClientAction) => void>()
      ...
      // Action dispatch structure: surfaceId comes from surface,
      // action.name and action.context come from the Button's action prop
