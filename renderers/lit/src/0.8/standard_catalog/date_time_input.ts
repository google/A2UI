...
import { isResolvedDateTimeInput } from '../data/guards.js';
import { AnyComponentNode, ResolvedMap } from '../types/types.js';

export const dateTimeInputCatalogItem: CatalogItem = {
  ...
  buildNode(
    ...
    if (!isResolvedDateTimeInput(resolvedProperties)) {
      throw new Error('Invalid properties for DateTimeInput component');
    }
    return new objCtor({
      ...baseNode,
      type: 'DateTimeInput',
