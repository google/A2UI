...
import { isResolvedMultipleChoice } from '../data/guards.js';
import { AnyComponentNode, ResolvedMap } from '../types/types.js';

export const multipleChoiceCatalogItem: CatalogItem = {
  ...
  buildNode(
    ...
    if (!isResolvedMultipleChoice(resolvedProperties)) {
      throw new Error('Invalid properties for MultipleChoice component');
    }
    return new objCtor({
      ...baseNode,
      type: 'MultipleChoice',
