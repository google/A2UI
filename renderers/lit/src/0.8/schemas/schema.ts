...
// Re-export JSON schema as TypeScript module 
// This avoids ESM import attribute issues by embedding the schema directly in code
export const serverToClientWithStandardCatalog = {
...
export default serverToClientWithStandardCatalog;
