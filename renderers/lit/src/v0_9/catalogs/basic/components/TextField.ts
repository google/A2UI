...
export class A2uiBasicTextFieldElement extends LitElement {

  @property({ type: Object }) accessor context!: ComponentContext;
  private controller!: A2uiController<typeof TextFieldApi>;
  ...
  willUpdate(changedProperties: Map<string, any>) {
    ...
    if (changedProperties.has('context') && this.context) {
      ...
      this.controller = new A2uiController(this, TextFieldApi);
    }
  }
