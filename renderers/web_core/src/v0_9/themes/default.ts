...
const aLight = merge(a, {});
const inputLight = merge(input, {});
const textareaLight = merge(textarea, {});
const buttonLight = merge(button, {});
const bodyLight = merge(body, {});
const pLight = merge(p, {});
const preLight = merge(pre, {});
