...
export declare interface AudioPlayer extends z.infer<
  typeof AudioPlayerSchema
> {}
...
export declare interface DateTimeInput extends z.infer<
  typeof DateTimeInputSchema
> {}
export declare interface MultipleChoice extends z.infer<
