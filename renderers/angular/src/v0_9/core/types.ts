...
/**
* Utility type to convert a schema interface generated by zod.infer to another interface
* where the values are wrapped in BoundProperty. This is used to correctly type the props()
* in a UI component
* 
* @example
...
* export type TextComponentSchema = z.infer<typeof TextComponentApi.schema>; // outputs { text: string; }
* export type TextProps = InferredInterfaceToProps<TextComponentSchema>; // outputs { text: BoundProperty<string>; }
*/
export type ComponentSchemaToProps<ComponentSchema extends {}> = InferredInterfaceToProps<ExtendedProps<ComponentSchema>>;
