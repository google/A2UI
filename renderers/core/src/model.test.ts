...
import { A2uiMessageProcessor } from "./processor/model-processor.js";
import { isObject } from "./guards/guards.js";
...
describe("A2uiMessageProcessor", () => {
  let processor = new A2uiMessageProcessor();
                ...
                valueMap: [
                  {
                    key: "item1",
                    valueMap: [
                      { key: "name", valueString: "Business 1" },
                      ...
                      { key: "address", valueString: "Address 1" },
                    ],
                  },
                  {
                    key: "item2",
                    valueMap: [
                      { key: "name", valueString: "Business 2" },
                      { key: "rating", valueString: "★★★★☆" },
                      { key: "detail", valueString: "Authentic and real." },
                      {
                        key: "infoLink",
                        valueString: "[More Info](https://www.example.com/)",
                      },
                      ...
                      { key: "address", valueString: "Address 2" },
                    ],
                  },
                  {
                    key: "item3",
                    valueMap: [
                      { key: "name", valueString: "Business 3" },
                      { key: "rating", valueString: "★★★★☆" },
                      {
                        key: "detail",
                        valueString:
                      ...
                      { key: "address", valueString: "Address 3" },
                    ],
                  },
                  {
                    key: "item4",
                    valueMap: [
                      { key: "name", valueString: "Business 4" },
                      { key: "rating", valueString: "★★★★★" },
                      { key: "detail", valueString: "Upscale dining." },
                      {
                        key: "infoLink",
                        valueString: "[More Info](https://www.example.com/)",
                      },
                      ...
                      { key: "address", valueString: "Address 4" },
                    ],
                  },
                  {
                    key: "item5",
                    valueMap: [
                      { key: "name", valueString: "Business 5" },
                      { key: "rating", valueString: "★★★★☆" },
                      { key: "detail", valueString: "Famous for its noodles." },
                      {
                        key: "infoLink",
                        valueString: "[More Info](https://www.example.com/)",
                      },
                      ...
                      { key: "address", valueString: "Address 5" },
                    ],
                  },
                ],
              },
