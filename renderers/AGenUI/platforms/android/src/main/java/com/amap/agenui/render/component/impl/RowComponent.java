...
/**
 * Row component implementation (horizontal layout) - compliant with A2UI v0.9 protocol
 *
 * Uses FlexContainerLayout (wraps FrameLayout + FlexboxLayout)
 *
 * Supported properties:
 * - children: list of child components (explicitList or template)
 * - justify: main-axis alignment (horizontal) - center, end, spaceAround, spaceBetween, spaceEvenly, start, stretch
 * - align: cross-axis alignment (vertical) - start, center, end, stretch
 *
 */
public class RowComponent extends A2UILayoutComponent {

    private static final String TAG = "RowComponent";
     ...
     * A2UI v0.9 protocol values: center, end, spaceAround, spaceBetween, spaceEvenly, start, stretch
     */
     ...
     * A2UI v0.9 protocol values: start, center, end, stretch
     */
