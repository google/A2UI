...
class ValidationTest {
    ...
    void testValidateA2uiJsonValidIntegrity() {
        ...
        payload.put("components", Arrays.asList(
                createComponent("root", "Column", Map.of("children", Collections.singletonList("child1"))),
                createComponent("child1", "Text", Map.of("text", "Hello"))
        ));
        assertDoesNotThrow(() -> Validation.validateA2uiJson(payload, schema));
    }
    ...
    void testValidateA2uiJsonDuplicateIds() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, 
                () -> Validation.validateA2uiJson(payload, schema));
    ...
    void testValidateA2uiJsonDanglingReferences(String componentType, String fieldName, Object idsToRef) {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> Validation.validateA2uiJson(payload, schema));
        assertTrue(exception.getMessage().contains("Component 'root' references missing ID 'missing_child' in field '" + fieldName + "'"));
    }
    ...
    void testValidateA2uiJsonSelfReference() {
        Map<String, Object> payload = new HashMap<>();
        payload.put("components", Collections.singletonList(
                createComponent("root", "Container", Map.of("children", Collections.singletonList("root")))
        ));
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> Validation.validateA2uiJson(payload, schema));
        assertTrue(exception.getMessage().contains("Self-reference detected: Component 'root' references itself in field 'children'"));
    }
    ...
    void testValidateA2uiJsonCircularReference() {
        Map<String, Object> payload = new HashMap<>();
        payload.put("components", Arrays.asList(
                createComponent("root", "Container", Map.of("children", Collections.singletonList("child1"))),
                createComponent("child1", "Container", Map.of("children", Collections.singletonList("root")))
        ));
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> Validation.validateA2uiJson(payload, schema));
    ...
    void testValidateA2uiJsonOrphanedComponent() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> Validation.validateA2uiJson(payload, schema));
        assertTrue(exception.getMessage().contains("Orphaned components detected (not reachable from 'root'): [orphan]"));
    }
    ...
    void testValidateA2uiJsonValidTopologyComplex() {
        Map<String, Object> payload = new HashMap<>();
        payload.put("components", Arrays.asList(
                createComponent("root", "Container", Map.of("children", Arrays.asList("child1", "child2"))),
                createComponent("child1", "Text", Map.of("text", "Hello")),
                createComponent("child2", "Container", Map.of("children", Collections.singletonList("child3"))),
    ...
    static Stream<Arguments> invalidPathsProvider() {
        return Stream.of(
                Arguments.of(Map.of("updateDataModel", Map.of("surfaceId", "surface1", "path", "invalid//path", "value", "data"))),
                Arguments.of(Map.of("components", Collections.singletonList(Map.of("id", "root", "componentProperties", Map.of("Text", Map.of("text", Map.of("path", "invalid path with spaces"))))))),
                Arguments.of(Map.of("updateDataModel", Map.of("surfaceId", "surface1", "path", "/invalid/escape/~2", "value", "data")))
        );
    }
    ...
    void testValidateGlobalRecursionLimitExceeded() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> Validation.validateA2uiJson(deepPayload, schema));
    ...
    void testValidateCustomSchemaReference() {
        ...
        Map<String, Object> componentTypes = new HashMap<>((Map<String, Object>) componentProperties.get("properties"));
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> Validation.validateA2uiJson(payload, customSchema));
