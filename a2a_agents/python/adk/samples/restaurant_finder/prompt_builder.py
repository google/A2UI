...
[
  ...
  {{ "surfaceUpdate": {{
    ...
    "components": [
      ...
      {{ "id": "booking-title", "component": {{ "Heading": {{ "level": "2", "text": {{ "literalString": "Book a Table at [RestaurantName]" }} }} }} }},
      {{ "id": "restaurant-image", "component": {{ "Image": {{ "url": {{ "literalString": "" }} }} }} }},
      {{ "id": "restaurant-address", "component": {{ "Text": {{ "text": {{ "literalString": "[Restaurant Address]" }} }} }} }},
      {{ "id": "party-size-field", "component": {{ "TextField": {{ "label": {{ "literalString": "Party Size" }}, "text": {{ "literalString": "2" }}, "textFieldType": "number" }} }} }},
      {{ "id": "datetime-field", "component": {{ "DateTimeInput": {{ "label": {{ "literalString": "Date & Time" }}, "value": {{ "literalString": "" }}, "enableDate": true, "enableTime": true }} }} }},
      {{ "id": "dietary-field", "component": {{ "TextField": {{ "label": {{ "literalString": "Dietary Requirements" }}, "text": {{ "literalString": "" }} }} }} }},
      {{ "id": "submit-button", "component": {{ "Button": {{ "child": "submit-reservation-text", "action": {{ "name": "submit_booking", "context": [ {{ "key": "restaurantName", "value": {{ "literalString": "[RestaurantName]" }} }}, {{ "key": "partySize", "value": {{ "literalString": "2" }} }}, {{ "key": "reservationTime", "value": {{ "literalString": "" }} }}, {{ "key": "dietary", "value": {{ "literalString": "" }} }}, {{ "key": "imageUrl", "value": {{ "literalString": "" }} }} ] }} }} }} }},
...
def get_ui_prompt(base_url: str, examples: str) -> str:
    ...
    --- UI TEMPLATE RULES ---
    -   You MUST use the `BOOKING_FORM_EXAMPLE` template.
...
def get_text_prompt() -> str:
    ...
    Your only capability is to help users book a table.
    """
