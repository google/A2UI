/**
 * A2UI Lit v0.9 Component Theme Overrides
 * Mimics the vibrant layout and gradient styling of the legacy shell_v0_9 configuration.
 */

export const overridesSheet = new CSSStyleSheet();
overridesSheet.replaceSync(`
:root {
  /* Button Overrides */
