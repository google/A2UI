...
const aLight = a; //v0_9.Styles.merge(a, {});
const inputLight = input; //v0_9.Styles.merge(input, {});
const textareaLight = textarea; //v0_9.Styles.merge(textarea, {});
const buttonLight = button; //v0_9.Styles.merge(button, {});
const bodyLight = body; //v0_9.Styles.merge(body, {});
const pLight = p; //v0_9.Styles.merge(p, {});
const preLight = pre; //v0_9.Styles.merge(pre, {});
const orderedListLight = orderedList; //v0_9.Styles.merge(orderedList, {});
const unorderedListLight = unorderedList; //v0_9.Styles.merge(unorderedList, {});
const listItemLight = listItem; //v0_9.Styles.merge(listItem, {});
