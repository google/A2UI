...
export class LocalGallery extends LitElement {
  ...
  static styles = [
    css`
      ...
      p.subtitle { color: #94a3b8; margin: 4px 0 0 0; font-size: 0.9rem; }
      ...
      .nav-desc { margin: 0; font-size: 0.8rem; color: #94a3b8; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;}
  ...
  render() {
    ...
    return html`
      ...
      <main>
        <nav class="nav-pane">
          ${this.demoItems.map((item, i) => html`
            <div class="nav-item ${i === this.activeItemIndex ? 'active' : ''}" @click=${() => this.selectItem(i)}>
        ...
        <section class="gallery-pane">
          <div class="preview-header">
            <div>
              ...
              <p style="margin:4px 0 0 0; font-size:0.9rem; color:#94a3b8">${activeItem?.description}</p>
            </div>
            <div class="stepper-controls">
              ...
              <button @click=${() => this.advanceMessages(false)} ?disabled=${!canAdvance}>+1 Message</button>
              <button @click=${() => this.advanceMessages(true)} ?disabled=${!canAdvance}>All Messages</button>
            </div>
          </div>
          
          <div class="preview-content">
            <div class="surface-container">
              ${surface ? html`<a2ui-surface .surface=${surface}></a2ui-surface>` : html`<div style="color: #64748b; text-align:center;">Surface not initialized. Click '+1 Message' to begin.</div>`}
            </div>
          </div>
        </section>
        ...
        <aside class="inspector-pane">
          ...
          <div class="inspector-section">
            ...
            <div class="inspector-body log-list">
              ${this.mockLogs.length === 0 ? html`<span style="color:#475569">No actions logged...</span>` : nothing}
