    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            id: 'command-list',
            children: [
              { type: 'Text', id: 'cmd-1', text: '• "restaurants" - Card list with actions', textStyle: 'body' },
              { type: 'Text', id: 'cmd-2', text: '• "contact" - Contact card layout', textStyle: 'body' },
              { type: 'Text', id: 'cmd-3', text: '• "dashboard" - Analytics cards', textStyle: 'body' },
              { type: 'Text', id: 'cmd-4', text: '• "form" - Input fields & checkboxes', textStyle: 'body' },
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              { type: 'Text', id: 'tag-1a', text: '🌿 Vegetarian', textStyle: 'caption' },
              { type: 'Text', id: 'tag-1b', text: '🍷 Full Bar', textStyle: 'caption' },
              { type: 'Text', id: 'tag-1c', text: '📍 North Beach', textStyle: 'caption' },
            ],
          },
        ],
        actions: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              { type: 'Text', id: 'tag-2a', text: '🍣 Omakase', textStyle: 'caption' },
              { type: 'Text', id: 'tag-2b', text: '🍶 Sake Bar', textStyle: 'caption' },
              { type: 'Text', id: 'tag-2c', text: '📍 Japantown', textStyle: 'caption' },
            ],
          },
        ],
        actions: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              { type: 'Text', id: 'tag-3a', text: '🌱 Vegan Options', textStyle: 'caption' },
              { type: 'Text', id: 'tag-3b', text: '🌶️ Spicy', textStyle: 'caption' },
              { type: 'Text', id: 'tag-3c', text: '📍 Mission', textStyle: 'caption' },
            ],
          },
        ],
        actions: [
        ...
        children: [
          {
            ...
            children: [
              { type: 'Column', id: 'bar-col-1', children: [
                { type: 'Text', id: 'bar-1', text: '▓\n▓\n▓', textStyle: 'code' },
                { type: 'Text', id: 'label-1', text: 'Mon', textStyle: 'caption' },
              ]},
              { type: 'Column', id: 'bar-col-2', children: [
                { type: 'Text', id: 'bar-2', text: '▓\n▓\n▓\n▓', textStyle: 'code' },
                { type: 'Text', id: 'label-2', text: 'Tue', textStyle: 'caption' },
              ]},
              { type: 'Column', id: 'bar-col-3', children: [
                { type: 'Text', id: 'bar-3', text: '▓\n▓', textStyle: 'code' },
                { type: 'Text', id: 'label-3', text: 'Wed', textStyle: 'caption' },
              ]},
              { type: 'Column', id: 'bar-col-4', children: [
                { type: 'Text', id: 'bar-4', text: '▓\n▓\n▓\n▓\n▓', textStyle: 'code' },
                { type: 'Text', id: 'label-4', text: 'Thu', textStyle: 'caption' },
              ]},
              { type: 'Column', id: 'bar-col-5', children: [
                { type: 'Text', id: 'bar-5', text: '▓\n▓\n▓', textStyle: 'code' },
                { type: 'Text', id: 'label-5', text: 'Fri', textStyle: 'caption' },
              ]},
              { type: 'Column', id: 'bar-col-6', children: [
                { type: 'Text', id: 'bar-6', text: '▓\n▓\n▓\n▓', textStyle: 'code' },
                { type: 'Text', id: 'label-6', text: 'Sat', textStyle: 'caption' },
              ]},
              { type: 'Column', id: 'bar-col-7', children: [
                { type: 'Text', id: 'bar-7', text: '▓\n▓', textStyle: 'code' },
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            id: 'checkbox-row-1',
            children: [
              { type: 'Text', id: 'check-1', text: '☑️ Receive email updates', textStyle: 'body' },
            ],
          },
          {
            type: 'Row',
            id: 'checkbox-row-2',
            children: [
              { type: 'Text', id: 'check-2', text: '☐ Enable notifications', textStyle: 'body' },
            ],
          },
          {
            type: 'Row',
            id: 'checkbox-row-3',
            children: [
              { type: 'Text', id: 'check-3', text: '☑️ Accept terms & conditions', textStyle: 'body' },
            ],
          },
          {
            type: 'Spacer',
            ...
            children: [
              {
                ...
                id: 'task-1-row',
                children: [
                  { type: 'Text', id: 'task-1-check', text: '✅', textStyle: 'body' },
                  { type: 'Column', id: 'task-1-content', children: [
                    { type: 'Text', id: 'task-1-title', text: 'Complete project proposal', textStyle: 'subtitle' },
                    { type: 'Text', id: 'task-1-meta', text: 'Completed yesterday', textStyle: 'caption' },
                  ]},
                ],
              },
            ],
            ...
            children: [
              {
                ...
                id: 'task-2-row',
                children: [
                  { type: 'Text', id: 'task-2-check', text: '✅', textStyle: 'body' },
                  { type: 'Column', id: 'task-2-content', children: [
                    { type: 'Text', id: 'task-2-title', text: 'Review design mockups', textStyle: 'subtitle' },
                    { type: 'Text', id: 'task-2-meta', text: 'Completed today', textStyle: 'caption' },
                  ]},
                ],
              },
            ],
            ...
            children: [
              {
                ...
                id: 'task-3-row',
                children: [
                  { type: 'Text', id: 'task-3-check', text: '⬜', textStyle: 'body' },
                  { type: 'Column', id: 'task-3-content', children: [
                    { type: 'Text', id: 'task-3-title', text: 'Schedule team meeting', textStyle: 'subtitle' },
                    { type: 'Text', id: 'task-3-meta', text: 'Due tomorrow', textStyle: 'caption' },
                  ]},
                ],
              },
            ],
            ...
            children: [
              {
                ...
                id: 'task-4-row',
                children: [
                  { type: 'Text', id: 'task-4-check', text: '⬜', textStyle: 'body' },
                  { type: 'Column', id: 'task-4-content', children: [
                    { type: 'Text', id: 'task-4-title', text: 'Prepare quarterly report', textStyle: 'subtitle' },
                    { type: 'Text', id: 'task-4-meta', text: 'Due in 3 days', textStyle: 'caption' },
                  ]},
                ],
              },
            ],
            actions: [
              { name: 'complete', id: 'complete-4', label: 'Done' },
            ],
          },
          {
            type: 'Card',
            ...
            children: [
              {
                ...
                id: 'task-5-row',
                children: [
                  { type: 'Text', id: 'task-5-check', text: '⬜', textStyle: 'body' },
                  { type: 'Column', id: 'task-5-content', children: [
                    { type: 'Text', id: 'task-5-title', text: 'Update documentation', textStyle: 'subtitle' },
                    { type: 'Text', id: 'task-5-meta', text: 'Due next week', textStyle: 'caption' },
                  ]},
                ],
              },
            ],
        ...
        children: [
          {
            ...
            id: 'primary-row',
            children: [
              { type: 'Button', id: 'btn-p1', label: 'Submit', variant: 'primary', action: { name: 'submit' } },
              { type: 'Button', id: 'btn-p2', label: 'Continue', variant: 'primary', action: { name: 'continue' } },
              { type: 'Button', id: 'btn-p3', label: 'Save', variant: 'primary', action: { name: 'save' } },
            ],
          },
        ],
      },
        ...
        children: [
          {
            ...
            id: 'secondary-row',
            children: [
              { type: 'Button', id: 'btn-s1', label: 'Cancel', variant: 'secondary', action: { name: 'cancel' } },
              { type: 'Button', id: 'btn-s2', label: 'Back', variant: 'secondary', action: { name: 'back' } },
              { type: 'Button', id: 'btn-s3', label: 'Skip', variant: 'secondary', action: { name: 'skip' } },
            ],
          },
        ],
      },
        ...
        children: [
          {
            ...
            id: 'icon-row',
            children: [
              { type: 'Button', id: 'btn-i1', label: '❤️ Like', variant: 'secondary', action: { name: 'like' } },
              { type: 'Button', id: 'btn-i2', label: '📤 Share', variant: 'secondary', action: { name: 'share' } },
              { type: 'Button', id: 'btn-i3', label: '💾 Save', variant: 'primary', action: { name: 'save' } },
            ],
          },
        ],
      },
  ...
  root: {
    ...
    children: [
      ...
      // Layout Components
      {
        ...
        children: [
          { type: 'Text', id: 'layout-desc', text: 'Row (horizontal) and Column (vertical) layouts:', textStyle: 'caption' },
          {
            type: 'Spacer',
            id: 'spacer-layout-1',
            height: 8,
          ...
          { type: 'Text', id: 'divider-note', text: '↑ Divider component above', textStyle: 'caption' },
        ],
      },
      {
        type: 'Spacer',
      ...
      // Interactive Components
      {
        ...
        children: [
          { type: 'Text', id: 'btn-desc', text: 'Button variants:', textStyle: 'caption' },
          {
            type: 'Spacer',
            id: 'spacer-int-1',
            height: 8,
          },
          {
            ...
            id: 'btn-demo-row',
            children: [
              { type: 'Button', id: 'demo-primary', label: 'Primary', variant: 'primary', action: { name: 'demo' } },
              { type: 'Button', id: 'demo-secondary', label: 'Secondary', variant: 'secondary', action: { name: 'demo' } },
            ],
          },
          {
            type: 'Spacer',
          ...
          { type: 'Text', id: 'input-desc', text: 'Input field:', textStyle: 'caption' },
          {
            type: 'Spacer',
            id: 'spacer-int-3',
            height: 8,
      ...
      // Spacer demo
      {
        ...
        children: [
          { type: 'Text', id: 'spacer-text-1', text: 'No spacer below', textStyle: 'body' },
          { type: 'Text', id: 'spacer-text-2', text: 'Text right after', textStyle: 'body' },
          { type: 'Spacer', id: 'demo-spacer', height: 24 },
          { type: 'Text', id: 'spacer-text-3', text: '24px spacer above', textStyle: 'body' },
        ],
      },
    ],
  } as Types.Node,
...
export function getDemoResponse(query: string): { text: string; surface?: Types.A2uiMessage } {
  ...
  // Contact queries
  if (q.includes('contact') || q.includes('person') || q.includes('profile') || q.includes('john') || q.includes('sarah')) {
    return {
  ...
  if (q.includes('analytics') || q.includes('chart') || q.includes('stats') || q.includes('dashboard') || q.includes('metrics')) {
    return {
  ...
  // Form/Input queries
  if (q.includes('form') || q.includes('input') || q.includes('signup') || q.includes('sign up') || q.includes('register')) {
    return {
      text: '📝 Here\'s a sign-up form demonstrating input components:',
      surface: DEMO_FORM_SURFACE,
    };
  }
  
  // List queries
  if (q.includes('list') || q.includes('task') || q.includes('todo') || q.includes('items') || q.includes('scroll')) {
    return {
      text: '📋 Here\'s a task list demonstrating the List component:',
      surface: DEMO_LIST_SURFACE,
    };
  }
  
  // Image/Gallery queries
  if (q.includes('image') || q.includes('photo') || q.includes('gallery') || q.includes('picture')) {
    return {
      text: '🖼️ Here\'s an image gallery demonstrating the Image component:',
  ...
  // Hello/Welcome
  if (q.includes('hello') || q.includes('hi') || q.includes('hey') || q.includes('welcome') || q.includes('start')) {
    return {
  ...
  // Help
  if (q.includes('help') || q.includes('what can') || q.includes('commands') || q.includes('options')) {
    return {
