...
ROLE_DESCRIPTION = "You are a helpful restaurant finding assistant. Your final output MUST be a a2ui UI JSON response."
...
if __name__ == "__main__":
    ...
    restaurant_prompt = A2uiSchemaManager("0.8", schema_modifiers=[remove_strict_validation]).generate_system_prompt(
        role_description=ROLE_DESCRIPTION,
        workflow_description=WORKFLOW_DESCRIPTION,
        ui_description=UI_DESCRIPTION,
        examples=RESTAURANT_UI_EXAMPLES
    )
