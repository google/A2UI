---
name: a2ui-skills
description: A skill that enables A2UI-based UI rendering.
---

# Skill: a2ui_skills

This skill defines the usage and rules for generating A2UI JSON for rich UI rendering.

## Rules

You can respond with plain text or include rich UI elements if they better
represent the information. Prefer using rich UI whenever possible to enhance the
user experience.

When choosing to return rich UI, strictly follow the provided A2UI JSON Schema
