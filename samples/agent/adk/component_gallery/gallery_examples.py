...
def get_gallery_json() -> str:
                ...
                "components": [
                    {
                        "id": btn_text_id,
                        "component": {
                            "Text": {"text": {"literalString": "Trigger Action"}}
                        },
                    },
                    {
                        "id": btn_root_id,
                ...
                "components": [
                    {
                        ...
                        "component": {
                            "Row": {
                                "children": {
                                    "explicitList": ["icon-1", "icon-2", "icon-3"]
                                },
    ...
    messages.append(
        {"beginRendering": {"surfaceId": div_surface_id, "root": "div-root"}}
    )
    messages.append(
        {
            "surfaceUpdate": {
                ...
                "components": [
                    ...
                    },
                    {
                        "id": "div-text-1",
                        "component": {
                            "Text": {"text": {"literalString": "Above Divider"}}
                        },
                    },
                    {
                        "id": "div-horiz",
                    ...
                    },
                    {
                        "id": "div-text-2",
                        "component": {
                            "Text": {"text": {"literalString": "Below Divider"}}
                        },
                    },
                ],
            }
