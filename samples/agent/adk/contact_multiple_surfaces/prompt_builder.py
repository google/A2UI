...
ROLE_DESCRIPTION = "You are a helpful contact lookup assistant. Your final output MUST be a a2ui UI JSON response."
...
if __name__ == "__main__":
    ...
    schema_manager = A2uiSchemaManager(
        "0.8", basic_examples_path="examples", accepts_inline_catalogs=True, schema_modifiers=[remove_strict_validation]
    )
    ...
    client_ui_capabilities_str = '{"inlineCatalogs":[{"catalogId": "inline_catalog", "components":{"OrgChart":{"type":"object","properties":{"chain":{"type":"array","items":{"type":"object","properties":{"title":{"type":"string"},"name":{"type":"string"}},"required":["title","name"]}},"action":{"$ref":"#/definitions/Action"}},"required":["chain"]},"WebFrame":{"type":"object","properties":{"url":{"type":"string"},"html":{"type":"string"},"height":{"type":"number"},"interactionMode":{"type":"string","enum":["readOnly","interactive"]},"allowedEvents":{"type":"array","items":{"type":"string"}}}}}}]}'
