...
class SchemaBundler:
    ...
    def __init__(self):
        ...
        self.ref_mapping = (
            {}
        )  # Maps (abs_file_path + fragment) -> internal #/$defs/ key
            ...
            if "$ref" in schema:
                ...
                if not ref.startswith("#"):
                    ...
                    if full_ref_id in self.ref_mapping:
                        ...
                        target_subschema = self.resolve_json_pointer(
                            file_data, fragment
                        )

                        # Generate a key for $defs
                        def_key = self.get_def_key(
                            full_ref_id, target_path.stem, fragment
                        )
...
def main():
    parser = argparse.ArgumentParser(
        description="Bundle JSON Schema $refs into internal $defs."
    )
