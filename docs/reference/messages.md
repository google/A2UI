...
- **[server_to_client.json](https://a2ui.org/specification/v0_8/json/server_to_client.json)**: Message envelope schema
- **[standard_catalog_definition.json](https://a2ui.org/specification/v0_8/json/standard_catalog_definition.json)**: Component schemas
