...
- **[server_to_client.json](../specification/v0.9/schemas/server_to_client.json)**: Message envelope schema.
- **[standard_catalog.json](../specification/v0.9/standard_catalog.json)**: Component schemas.
