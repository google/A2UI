...
See [the evolution guide](v0.10-evolution-guide.md) for a detailed explanation of the differences between v0.9 and v0.10.
...
[`standard_catalog.json`]: ../standard_catalog.json
[`common_types.json`]: ../common_types.json
[`server_to_client.json`]: ../server_to_client.json
[`client_to_server.json`]: ../client_to_server.json
[`a2ui_client_capabilities.json`]: ../a2ui_client_capabilities.json
[`a2ui_client_data_model.json`]: ../a2ui_client_data_model.json
