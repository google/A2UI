...
Please do not propose changes here. If you have proposed changes or new features, please open an issue or submit a pull request to the [A2UI repository](https://github.com/google/A2UI) for the [v0.10 specification](../v0_10/README.md).
