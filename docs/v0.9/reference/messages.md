...
- **[server_to_client.json](../specification/server_to_client.json)**: Message envelope schema.
- **[standard_catalog.json](../specification/standard_catalog.json)**: Component schemas.
