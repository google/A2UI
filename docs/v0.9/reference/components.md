...
This page showcases all standard A2UI components with examples and usage patterns. For the complete technical specification, see the [Standard Catalog Definition](../specification/standard_catalog.json).
...
- **[Standard Catalog Definition](../specification/standard_catalog.json)**: Complete technical specification
