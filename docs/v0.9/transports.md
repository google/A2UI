...
**See:** [A2A Extension Specification](../v0.8/specification/docs/v0.8-a2a-extension.md)
...
- **[A2A Extension Spec](../v0.8/specification/docs/v0.8-a2a-extension.md)**: A2UI + A2A details