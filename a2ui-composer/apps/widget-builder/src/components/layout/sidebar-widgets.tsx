      ...
      >
        ...
        <DropdownMenu open={isMenuOpen} onOpenChange={setIsMenuOpen}>
          ...
          <DropdownMenuContent align="end" className="w-40">
            <DropdownMenuItem onClick={(e) => { e.preventDefault(); handleRename(); }}>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              All widget studio is stored locally on your device so there is no backup. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
