...
| **Client Catalog**    | `dynamicCatalog`                       | `inlineCatalog`                                      |
...
**v0.8 (`clientUiCapabilities`)**:

- Property: `dynamicCatalog`.

**v0.9 (`clientUiCapabilities`)**:

- **Removed**: `clientUiCapabilities`.
- **Reason**: The client capabilities are now sent with each A2A message as metadata.
