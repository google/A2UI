...
An A2UI message is a JSON object that can have a `surfaceId` and one of the following properties, defining the message type: `beginRendering`, `udpateComponents`, `udpateDataModel`, or `deleteSurface`.
