...
export const prompts: TestPrompt[] = [
  ...
  },
  {
    ...
    promptText: `Generate a JSON message containing a updateComponents to describe the following UI:
...
`,
  ...
  },
  {
    ...
    promptText: `Generate a JSON message containing a updateComponents for a login form. It should have a "Login" text (usageHint 'h1'), two text fields for username and password (bound to /login/username and /login/password), a checkbox for "Remember Me" (bound to /login/rememberMe), and a "Sign In" button. The button should trigger a 'login' action, passing the username, password, and rememberMe status in the dynamicContext.`,
    matchers: [
      new MessageTypeMatcher("updateComponents"),
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a simplified UI explorer for the Animal Kingdom.
...
`,
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a contact card. It should be a 'Card' with a 'Row'. The row contains an 'Image' (as an avatar) and a 'Column'. The column contains a 'Text' for the name "Jane Doe", a 'Text' for the email "jane.doe@example.com", and a 'Text' for the phone number "(123) 456-7890". Below the main row, add a 'Button' labeled "View on Map".`,
    matchers: [
      new MessageTypeMatcher("updateComponents"),
      new SurfaceUpdateSchemaMatcher("Column"),
      new SurfaceUpdateSchemaMatcher("Image"),
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a product details page.
...
- A 'Text' component for the product description below the button.`,
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for an interactive analytics dashboard.
...
Finally, a large 'Card' at the bottom with a 'Text' (usageHint 'h2') "Revenue Over Time" and a placeholder 'Image' with a valid URL to represent a line chart.`,
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a travel itinerary for a trip to Paris.
...
Each activity in the inner lists should be a 'Row' containing a 'CheckBox' (to mark as complete) and a 'Text' component with the activity description.`,
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a Kanban board. It should have a 'Text' (usageHint 'h1') "Project Tasks". Below, a 'Row' containing three 'Column's representing "To Do", "In Progress", and "Done". Each column should have a 'Text' (usageHint 'h2') header and a list of 'Card's.
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a video call interface. It should have a large 'Image' for the main speaker. Below that, a 'Row' of smaller 'Image's for other participants. At the bottom, a control bar 'Row' with three 'Button's: "Mute", "Stop Video", and "End Call".`,
    matchers: [
      new MessageTypeMatcher("updateComponents"),
      new SurfaceUpdateSchemaMatcher("Image"),
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a file browser. It should have a 'Text' (usageHint 'h1') "My Files". Then a 'List' of files. Each item in the list should be a 'Row' containing an 'Image' (icon) and a 'Text' (filename). Examples: "Document.pdf", "Photo.jpg", "Budget.xlsx".`,
    matchers: [
      new MessageTypeMatcher("updateComponents"),
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a fitness tracker. It should have a 'Text' (usageHint 'h1') "Daily Activity". A 'Row' with three 'Card's:
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a smart home control panel. It should have a 'Text' (usageHint 'h1') "Home Control". A 'List' of rooms.
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a restaurant menu. It should have a 'Text' (usageHint 'h1') "Gourmet Bistro". A 'Tabs' component with "Starters", "Mains", "Desserts".
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a news feed. It should have a 'Text' (usageHint 'h1') "Top Headlines". A 'List' of 'Card's.
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a photo editor. It should have a large 'Image' (the photo). Below, a 'Column' of adjustments.
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a trivia quiz. It should be a 'Card' with a 'Text' (h2) "Question 1 of 10". 'Text' "What is the capital of France?". A 'MultipleChoice' with options "London", "Berlin", "Paris", "Madrid". A 'Button' labeled "Submit Answer".`,
    matchers: [
      new MessageTypeMatcher("updateComponents"),
      new SurfaceUpdateSchemaMatcher("Card"),
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a calculator. It should have a 'Card'. Inside, a 'Text' (display) showing "0". Then a 'Column' of 'Row's for buttons.
    - Row 1: "7", "8", "9", "/"
    - Row 2: "4", "5", "6", "*"
    - Row 3: "1", "2", "3", "-"
    - Row 4: "0", ".", "=", "+"
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a job application. 'Text' (h1) "Join Our Team". 'TextField' "Full Name". 'TextField' "Email Address". 'TextField' "Link to Resume". 'TextField' "Cover Letter" (multiline). 'Button' "Submit Application".`,
    matchers: [
      new MessageTypeMatcher("updateComponents"),
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a course syllabus. 'Text' (h1) "Introduction to Computer Science". 'List' of modules.
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a stock watchlist. 'Text' (h1) "Market Watch". 'List' of 'Row's.
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a podcast player. 'Card' containing:
    - 'Image' (Cover Art).
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for hotel search results. 'Text' (h1) "Hotels in Tokyo". 'List' of 'Card's.
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a notification center. 'Text' (h1) "Notifications". 'List' of 'Card's.
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for cinema seat selection. 'Text' (h1) "Select Seats". 'Text' "Screen" (centered). 'Column' of 'Row's representing rows of seats.
    - Row A: 4 'CheckBox'es.
    - Row B: 4 'CheckBox'es.
    - Row C: 4 'CheckBox'es.
  ...
  },
  {
    ...
    promptText: `Generate a JSON message with a updateComponents property for a flashcard app. 'Text' (h1) "Spanish Vocabulary". 'Card' (the flashcard). Inside the card, a 'Column' with 'Text' (h2) "Hola" (Front). 'Divider'. 'Text' "Hello" (Back - conceptually hidden, but rendered here). 'Row' of buttons: "Hard", "Good", "Easy".`,
    matchers: [
      new MessageTypeMatcher("updateComponents"),
